...
//  Todo
//
//  Created by ChengXian on 11/17/14.
//  Copyright (c) 2014 ChengXian-Lim. All rights reserved.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate, TDMenuVCDelegate
{
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "dvid.Todo" in the application's documents Application Support directory.
